...
RegisterNetEvent('bookafishing:client:ReturnBoat', function(args)
	local ped = PlayerPedId()
...
RegisterNetEvent('bookafishing:client:rentaBoat', function(args)
	local args = tonumber(args)
...
RegisterNetEvent('bookafishing:client:BoatMenu', function(data)
	local ped = PlayerPedId()
