...
function BoatMenuLaPuerta()
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                event = "bookafishing:client:rentaBoat",
				args = 1
            }
        },
        {
...
function ReturnBoatLaPuerta()
    exports['qb-menu']:openMenu({
        ...
        },
		{
            ...
            params = {
                event = "bookafishing:client:ReturnBoat",
				args = 1
            }
        },
        {
...
RegisterNetEvent('bookafishing:client:SellLegalFish')
AddEventHandler('bookafishing:client:SellLegalFish', function()
    exports['qb-menu']:openMenu({
		{
...
RegisterNetEvent('bookafishing:client:buyFishingGear')
AddEventHandler('bookafishing:client:buyFishingGear', function() 
    exports['qb-menu']:openMenu({
		{
...
RegisterNetEvent('bookafishing:client:SellillegalFish')
AddEventHandler('bookafishing:client:SellillegalFish', function() 
